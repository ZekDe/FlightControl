...
#define EKF_GRAVITY_NED     9.81f   /**< Gravity magnitude [m/sÂ²] in NED (down positive) */
...
struct EKF_Handle_s {
    ...
    Matrix_t temp7x7_3;                  /**< Temporary 7x7 matrix (P_new) */
    Matrix_t temp7x3;                    /**< Temporary 7x3 matrix (H') */
    Matrix_t temp7x3_2;                  /**< Temporary 7x3 matrix (P*H') */
    Matrix_t temp3x7;                    /**< Temporary 3x7 matrix */
    Matrix_t temp3x3;                    /**< Temporary 3x3 matrix (S) */
    Matrix_t temp3x3_2;                  /**< Temporary 3x3 matrix (S_inv) */
};
 ...
 * @return EKF_OK on success, error code otherwise
 * 
 * @details q_dot = 0.5 * q âŠ— [0, omega]
 */
