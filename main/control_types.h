 ...
 * @{
 */
#define CTRL_IMU_RATE_HZ            1000    /**< IMU sampling rate [Hz] */
#define CTRL_RATE_PID_HZ            1000    /**< Inner loop (rate PID) frequency [Hz] */
#define CTRL_ANGLE_PID_HZ           500     /**< Outer loop (angle PID) frequency [Hz] */
#define CTRL_EKF_UPDATE_HZ          500     /**< EKF update frequency [Hz] */

#define CTRL_RATE_PID_DT            (1.0f / CTRL_RATE_PID_HZ)   /**< Rate PID period [s] */
#define CTRL_ANGLE_PID_DT           (1.0f / CTRL_ANGLE_PID_HZ)  /**< Angle PID period [s] */
/** @} */
